...
from dataset_statod_0116 import TrajectoryDataset
from model_0115.trainer import DiffusionTrainer, UQTrainer, NppcTrainer
from model_0115.diffusion_ddim import DiffusionProcess
from model_0115.predictor import *
from model_0115.eta_trainer import ETATrainer
from model_0115.denoiser import Unet
import plotly.express as px

parser = ArgumentParser()
parser.add_argument('--cuda', help='the index of the cuda device', type=int, default=1)
# Dataset arguments
parser.add_argument('-n', '--name', help='the name of the dataset', type=str, default='1101_1116_15s_0117_3channel_S20')
parser.add_argument('--gen_image_name', help=' supp name of the generated images', type=str, default='01311100')
...
parser.add_argument('--loadepoch_denoiser', help='load the denoiser best in the epoch of', default=160)
parser.add_argument('--loadepoch_nppc', help='the training epoch to load from, set to -1 for loading from the final model', default=74)
...
parser.add_argument('--draw_nppc', help='whether to draw generated nppc images', default=True)
