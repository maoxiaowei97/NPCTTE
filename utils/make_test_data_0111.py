...
test_image_meta_path = '/data/XinZhi/ODUQ/DOT/data/20181101_20181110_all_15s_td_0110_S20_FFalse_image_test_10w.npz'
images = {}
update_images = {}
...
for i, label in enumerate(['train', 'val', 'test']):
    if label == 'train':
        images[i] = (loaded_images['train_image'][:100000], loaded_images['train_odt'][:100000],
                      loaded_images['train_arr'][:100000])
    elif label == 'val':
        images[i] = (loaded_images['train_image'][100000:110000], loaded_images['train_odt'][100000:110000],
                     loaded_images['train_arr'][100000:110000])
    elif label == 'test':
        images[i] = (loaded_images['train_image'][110000:120000], loaded_images['train_odt'][110000:120000],
                     loaded_images['train_arr'][110000:120000])
